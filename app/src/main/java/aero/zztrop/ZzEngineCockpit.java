...
public class ZzEngineCockpit {
	...
	public void computeRest() {
		...
		// PATTERN_Rplus1h_R_R (Swiss),
		if (pattern.equals("R + 1h / R / R")) {

			restShort
					.setTimeInMillis((amp.getTimeInMillis() - convertMinutesToMillis(60) -
							convertMinutesToMillis(pause * 2)) / 3);
			...
			calTempEnd.setTimeInMillis(calTempStart.getTimeInMillis()
					+ restShort.getTimeInMillis() + convertMinutesToMillis(60));
			alTimePairs.add(new TimePair(calTempStart, calTempEnd,
					PERIOD_TYPE_REST));
