...
public class ScreenTimeKeypadService extends ScreenTimeKeypad implements
    ...
    private void loadPrefs() {
        ...
        if (!btnMem01.getText().toString().equals(getResources().getString(R.string.btnMem))) {
            btnMem01.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 16);
            btnMem01.setTextColor(getResources().getColor(R.color.colorLightGrey));
        }

        if (!btnMem02.getText().toString().equals(getResources().getString(R.string.btnMem))) {
            btnMem02.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 16);
            btnMem02.setTextColor(getResources().getColor(R.color.colorLightGrey));
        }

        if (!btnMem03.getText().toString().equals(getResources().getString(R.string.btnMem))) {
            btnMem03.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 16);
            btnMem03.setTextColor(getResources().getColor(R.color.colorLightGrey));
        }

        if (!btnMem04.getText().toString().equals(getResources().getString(R.string.btnMem))) {
            btnMem04.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 16);
            btnMem04.setTextColor(getResources().getColor(R.color.colorLightGrey));
        }

        if (!btnMem05.getText().toString().equals(getResources().getString(R.string.btnMem))) {
            btnMem05.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 16);
            btnMem05.setTextColor(getResources().getColor(R.color.colorLightGrey));
        }

        if (!btnMem06.getText().toString().equals(getResources().getString(R.string.btnMem))) {
            btnMem06.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 16);
            btnMem06.setTextColor(getResources().getColor(R.color.colorLightGrey));
        }

        if (!btnMem07.getText().toString().equals(getResources().getString(R.string.btnMem))) {
            btnMem07.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 16);
            btnMem07.setTextColor(getResources().getColor(R.color.colorLightGrey));
        }

        if (!btnMem08.getText().toString().equals(getResources().getString(R.string.btnMem))) {
            btnMem08.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 16);
            btnMem08.setTextColor(getResources().getColor(R.color.colorLightGrey));
        }
    }
    ...
    public boolean onLongClick(View v) {
        ...
        if (etTime.getText().toString().equals("")) {
            ((Button) v).setTextColor(getResources().getColor(R.color.colorMediumGrey));
            ...
            ((Button) v).setTextColor(getResources().getColor(R.color.colorLightGrey));
